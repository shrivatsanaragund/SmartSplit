...
//                }
                LabeledSection(label: "Category") {
                    ...
                    .frame(maxHeight: 150) // Limit height if necessary
//                    .foregroundStyle(LinearGradient(gradient: Gradient(colors: [Color.orange, Color.red]), startPoint: .topLeading, endPoint: .bottomTrailing))
                }
...
//                        .shadow(color: Color.gray.opacity(0.5), radius: 5, x: 0, y: 2)
                    Text("Save Expense")
                        ...
                        .background(
                            ...
                            AnyView(Color.gray) : // Wrapping Color in AnyView
                            AnyView(LinearGradient(gradient: Gradient(colors: [Color.orange, Color.red]), startPoint: .topLeading, endPoint: .bottomTrailing)) // Wrapping LinearGradient in AnyView
                        )
                        .foregroundColor(.white)
                        .cornerRadius(10)
                        .shadow(color: Color.gray.opacity(0.5), radius: 5, x: 0, y: 2)
                ...
                .disabled(isSaveButtonDisabled) // Disable the button
                .padding(.top, 20)
