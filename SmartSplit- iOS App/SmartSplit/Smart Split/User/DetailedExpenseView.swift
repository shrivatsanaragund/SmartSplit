...
struct DetailedExpenseView: View {
    ...
    @State private var availableCategories = ["Entertainment", "Food and Drink", "Household", "Healthcare", "Transportation", "Utilities", "Other"]
    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 15) {
                ...
                // Category Section (Editable only when isEditing is true)
    ...
    private func getOwedMessages(for expense: Expense, currentUserName: String) -> [String] {
